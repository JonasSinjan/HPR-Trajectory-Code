...
T_avg_1 = t_1 * I_1 # avg thrust (Newtons)
mr_1 = 0.50  # empty mass (no motor) of just first stage (kg) ----- UNKNOWN GUESS ATM
me_1 = 0.495  # mass of motor (kg)
...
T_avg_2 = t_2 * I_2 # avg thrust (Newtons)
mr_2 = 0.75  # empty mass (no motor) (kg) ------ UNKNOWN GUESS ATM
